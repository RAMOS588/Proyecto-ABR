...
public:
    ...
    void buscarMiembro(int id) {
        ...
        else cout << "El ID no existe en el árbol.\n";
    }
...
int main() {
    ...
    do {
        ...
        cout << "3. Eliminar miembro del árbol\n";
        cout << "4. Mostrar recorrido INORDEN\n";
        cout << "5. Mostrar recorrido PREORDEN\n";
        cout << "6. Mostrar recorrido POSTORDEN\n";
        cout << "7. Mostrar árbol por niveles\n";
        cout << "8. Mostrar esquema del árbol (vista piramidal)\n";
        cout << "9. Cargar árbol de ejemplo: Civilización ANKARAI\n";
        ...
        if (op == 1) {
            ...
            cout << "Si el ID existía, ha sido eliminado.\n";
        }
            ...
            cout << "\n--- RECORRIDO PREORDEN (útil para genealogía) ---\n";
            A.mostrarPreorden();
        }
            ...
            cout << "\n--- ÁRBOL POR NIVELES (generaciones) ---\n";
            A.verNiveles();
        }
            ...
            cout << "\nCargando árbol genealógico de la civilización ANKARAI...\n";
            A.cargarAnkarai();
            cout << "Árbol cargado exitosamente.\n";
        }
